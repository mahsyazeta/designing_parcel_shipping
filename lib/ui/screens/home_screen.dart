import 'package:designing_parcel_shipping/ui/widgets/widgets.dart';
        ...
        slivers:<Widget>[
          ...
          actions: [
            Padding(
              ...
              child: CircleAvatar(
                child: ClipOval(
                  child: Image.network('https://lh3.googleusercontent.com/a-/AOh14GhEWi_hvVFtyGQ3XBDqyb_uipvvJAzV_k51XKCT=s360-p-rw-no'),
                ),
              ),
            ),
          ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: TextButton(
                            onPressed: (){},
                            child: Text('Track parcel',style: Theme.of(context).textTheme.bodyText1,),
